...
def parser_options():
    ...
    parser.add_argument('--path_opt', default='option/RSICD_mca/RSICD_GaLR_mca.yaml', type=str,
                        help='path to a yaml options file')
    parser.add_argument('--resume', default='checkpoint/rsicd_GaLR_mca_SGA_DYNAMIC/2/GaLR_mca_best.pth.tar', type=str,
                        help='path to a yaml options file')
